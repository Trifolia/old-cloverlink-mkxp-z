...
std::unordered_map<int, int> vKeyToScancode{
    ...
    // 0x06 XBUTTON 2
    // 0x07 undef
    m(0x08, BACKSPACE), m(0x09, TAB),
    // 0x0a reserved
    // 0x0b reserved
    m(0x0c, CLEAR), m(0x0d, RETURN),
    // 0x0e undefined
    // 0x0f undefined
    // 0x10 SHIFT (both)
    // 0x11 CONTROL (both)
    // 0x12 ALT (both)
    m(0x13, PAUSE), m(0x14, CAPSLOCK),
    // 0x15 KANA, HANGUL
    // 0x16 undefined
    // 0x17 JUNJA
    // 0x18 FINAL
    ...
    // 0x1e ACCEPT
    // 0x1f MODECHANGE
    m(0x20, SPACE), m(0x21, PAGEUP), m(0x22, PAGEDOWN), m(0x23, END),
    m(0x24, HOME), m(0x25, LEFT), m(0x26, UP), m(0x27, RIGHT), m(0x28, DOWN),
    m(0x29, SELECT),
    // 0x2A print
    m(0x2b, EXECUTE), m(0x2c, PRINTSCREEN), m(0x2d, INSERT), m(0x2e, DELETE),
    m(0x2f, HELP), m(0x30, 0), m(0x31, 1), m(0x32, 2), m(0x33, 3), m(0x34, 4),
    m(0x35, 5), m(0x36, 6), m(0x37, 7), m(0x38, 8), m(0x39, 9),
    // 0x3a-0x40 undefined
    m(0x41, A), m(0x42, B), m(0x43, C), m(0x44, D), m(0x45, E), m(0x46, F),
    m(0x47, G), m(0x48, H), m(0x49, I), m(0x4a, J), m(0x4b, K), m(0x4c, L),
    m(0x4d, M), m(0x4e, N), m(0x4f, O), m(0x50, P), m(0x51, Q), m(0x52, R),
    m(0x53, S), m(0x54, T), m(0x55, U), m(0x56, V), m(0x57, W), m(0x58, X),
    m(0x59, Y), m(0x5a, Z), m(0x5b, LGUI), m(0x5c, RGUI), m(0x5d, APPLICATION),
    // 0x5e reserved
    m(0x5f, SLEEP), m(0x60, KP_0), m(0x61, KP_1), m(0x62, KP_2), m(0x63, KP_3),
    m(0x64, KP_4), m(0x65, KP_5), m(0x66, KP_6), m(0x67, KP_7), m(0x68, KP_8),
    m(0x69, KP_9), m(0x6a, KP_MULTIPLY), m(0x6b, KP_PLUS),
    m(0x6c, RETURN), // SEPARATOR
    m(0x6d, KP_MINUS), m(0x6e, KP_DECIMAL), m(0x6f, KP_DIVIDE), m(0x70, F1),
    m(0x71, F2), m(0x72, F3), m(0x73, F4), m(0x74, F5), m(0x75, F6),
    m(0x76, F7), m(0x77, F8), m(0x78, F9), m(0x79, F10), m(0x7a, F11),
    m(0x7b, F12), m(0x7c, F13), m(0x7d, F14), m(0x7e, F15), m(0x7f, F16),
    m(0x80, F17), m(0x81, F18), m(0x82, F19), m(0x83, F20), m(0x84, F21),
    m(0x85, F22), m(0x86, F23), m(0x87, F24),
    // 0x88-0x8f unassigned
    m(0x90, NUMLOCKCLEAR), m(0x91, SCROLLLOCK),
    // 0x92-0x96 oem specific
    // 0x97-0x9f unassigned
    m(0xa0, LSHIFT), m(0xa1, RSHIFT), m(0xa2, LCTRL), m(0xa3, RCTRL),
    m(0xa4, LALT), m(0xa5, RALT), m(0xa6, AC_BACK), m(0xa7, AC_FORWARD),
    m(0xa8, AC_REFRESH), m(0xa9, AC_STOP), m(0xaa, AC_SEARCH),
    // 0xab BROWSER_FAVORITES
    m(0xac, AC_HOME), m(0xad, MUTE), m(0xae, VOLUMEDOWN), m(0xaf, VOLUMEUP),
    m(0xb0, MEDIA_NEXT_TRACK), m(0xb1, MEDIA_PREVIOUS_TRACK),
    m(0xb2, MEDIA_STOP), m(0xb3, MEDIA_PLAY), m(0xb4, CALL),
    m(0xb5, MEDIA_SELECT),
    // 0xb6 LAUNCH_APP1
    // 0xb7 LAUNCH_APP2
    // 0xb8-0xb9 reserved
    ...
    m(0xba, SEMICOLON), m(0xbb, EQUALS), m(0xbc, COMMA), m(0xbd, MINUS),
    m(0xbe, PERIOD), m(0xbf, SLASH), m(0xc0, GRAVE),
    // 0xc1-0xd7 reserved
    // 0xd8-0xda unassigned
    m(0xdb, LEFTBRACKET), m(0xdc, BACKSLASH), m(0xdd, RIGHTBRACKET),
    m(0xde, APOSTROPHE),
    // 0xdf OEM_8
    // 0xe0 reserved
    // 0xe1 oem-specific
...
std::unordered_map<std::string, int> strToScancode{m_number(0),
                                                   m_number(1),
                                                   m_number(2),
                                                   m_number(3),
                                                   m_number(4),
...
std::unordered_map<std::string, SDL_GamepadButton> strToGCButton{
    ...
    m(BACK),        m(GUIDE),         m(START),          m(LEFT_STICK),
    m(RIGHT_STICK), m(LEFT_SHOULDER), m(RIGHT_SHOULDER), m(DPAD_UP),
    m(DPAD_DOWN),   m(DPAD_LEFT),     m(DPAD_RIGHT)

};

#undef m

const char *axisNames[]{"LStick X", "LStick Y", "RStick X",
                        "RStick Y", "LTrigger", "RTrigger"};

const char *buttonNames[]{
    "Pad A",       "Pad B",       "Pad X",       "Pad Y",       "Pad Back",
    "Pad Guide",   "Pad Start",   "Pad LS",      "Pad RS",      "Pad LB",
    "Pad RB",      "Pad Up",      "Pad Down",    "Pad Left",    "Pad Right",
    "Pad Misc",    "Pad Paddle1", "Pad Paddle2", "Pad Paddle3", "Pad Paddle4",
    "Pad Touchpad"};
...
struct ButtonState {
  ...
  ButtonState()
      : pressed(false), triggered(false), repeated(false), released(false) {}
};
...
struct Binding {
  Binding(Input::ButtonCode target = Input::None) : target(target) {}
...
struct KbBinding : public Binding {
  ...
  KbBinding(const KbBindingData &data)
      : Binding(data.target), source(data.source) {}
...
struct CtrlButtonBinding : public Binding {
  ...
  bool sourceRepeatable() const { return true; }
...
struct MsBinding : public Binding {
  ...
  bool sourceActive() const { return EventThread::mouseState.buttons[index]; }
...
static const KbBindingData staticKbBindings[] = {
    {SDL_SCANCODE_LSHIFT, Input::Shift}, {SDL_SCANCODE_RSHIFT, Input::Shift},
    {SDL_SCANCODE_LCTRL, Input::Ctrl},   {SDL_SCANCODE_RCTRL, Input::Ctrl},
    {SDL_SCANCODE_LALT, Input::Alt},     {SDL_SCANCODE_RALT, Input::Alt},
    {SDL_SCANCODE_F5, Input::F5},        {SDL_SCANCODE_F6, Input::F6},
    {SDL_SCANCODE_F7, Input::F7},        {SDL_SCANCODE_F8, Input::F8},
...
static const Input::ButtonCode dirs[] = {Input::Down, Input::Left, Input::Right,
                                         Input::Up};

static const int dirFlags[] = {1 << Input::Down, 1 << Input::Left,
                               1 << Input::Right, 1 << Input::Up};

/* Dir4 is always zero on these combinations */
static const int deadDirFlags[] = {dirFlags[0] | dirFlags[3],
...
struct InputPrivate {
  ...
  // Raw keystates
  uint8_t rawStateArray[SDL_SCANCODE_COUNT * 2];

  uint8_t *rawStates;
  uint8_t *rawStatesOld;

  // Gamepad button states
  uint8_t rawButtonStateArray[SDL_GAMEPAD_BUTTON_COUNT * 2];

  uint8_t *rawButtonStates;
  uint8_t *rawButtonStatesOld;

  // Gamepad axes & mouse coordinates
  int16_t axisStateArray[SDL_GAMEPAD_AXIS_COUNT];
  int mousePos[2];
  bool mouseInWindow;
  ...
  InputPrivate(const RGSSThreadData &rtData) {
    ...
    rawStatesOld = rawStateArray + SDL_SCANCODE_COUNT;

    rawButtonStates = rawButtonStateArray;
    rawButtonStatesOld = rawButtonStateArray + SDL_GAMEPAD_BUTTON_COUNT;
  ...
  ButtonState getStateRaw(int code, bool useVKey) {
    ...
    b.repeated = (rawRepeating == scancode) &&
                 (rawRepeatCount >= repeatStart &&
                  ((rawRepeatCount + 1) % repeatDelay) == 0);
  ...
  ButtonState getControllerButtonState(int button) {
    ...
    b.repeated = (buttonRepeating == button) &&
                 (buttonRepeatCount >= repeatStart &&
                  ((buttonRepeatCount + 1) % repeatDelay) == 0);
  ...
  void clearBuffer() {
    ...
    memset(rawStates, 0, SDL_SCANCODE_COUNT);

    memset(rawButtonStates, 0, SDL_GAMEPAD_BUTTON_COUNT);
  }
  ...
  template <class B> void appendBindings(std::vector<B> &bind) {
  ...
  void updateRaw() {
    ...
    memcpy(rawStates, shState->eThread().keyStates, SDL_SCANCODE_COUNT);
  ...
  void updateControllerRaw() {
    ...
    memcpy(rawButtonStates, shState->eThread().controllerState.buttons,
...
Input::Input(const RGSSThreadData &rtData) { p = new InputPrivate(rtData); }

double Input::getDelta() { return shState->runTime() - p->last_update; }

void Input::recalcRepeat(unsigned int fps) { p->recalcRepeatTime(fps); }
...
void Input::update() {
  ...
  if (p->getState(p->repeating).pressed) {
     ...
     */
    bool repeated = p->repeatCount >= p->repeatStart &&
                    ((p->repeatCount + 1) % p->repeatDelay) == 0;
  ...
  p->vScrollDistance =
      SDL_SetAtomicInt(&EventThread::verticalScrollDistance, 0);
...
bool Input::isPressed(int button) { return p->getStateCheck(button).pressed; }

bool Input::isTriggered(int button) {
  return p->getStateCheck(button).triggered;
}

bool Input::isRepeated(int button) { return p->getStateCheck(button).repeated; }

bool Input::isReleased(int button) { return p->getStateCheck(button).released; }
...
bool Input::mouseInWindow() { return p->mouseInWindow; }

int Input::dir4Value() { return p->dir4Data.active; }

int Input::dir8Value() { return p->dir8Data.active; }

int Input::mouseX() {
  RGSSThreadData &rtData = shState->rtData();

  int hiresResult =
      (p->mousePos[0] - rtData.screenOffset.x) * rtData.sizeResoRatio.x;
...
int Input::mouseY() {
  ...
  int hiresResult =
      (p->mousePos[1] - rtData.screenOffset.y) * rtData.sizeResoRatio.y;
...
int Input::scrollV() { return p->vScrollDistance; }
...
bool Input::getTextInputMode() {
  return (SDL_TextInputActive(shState->sdlWindow()) == true);
}
...
void Input::clearText() { shState->eThread().textInputBuffer.clear(); }
...
char *Input::getClipboardText() {
  ...
  if (!tx)
    throw Exception(Exception::SDLError, "Failed to get clipboard text: %s",
                    SDL_GetError());
  return tx;
}
...
void Input::setClipboardText(char *text) {
  if (SDL_SetClipboardText(text))
    throw Exception(Exception::SDLError, "Failed to set clipboard text: %s",
                    SDL_GetError());
}
...
Input::~Input() { delete p; }

bool Input::hasQuit() { return p->triedExit; }
